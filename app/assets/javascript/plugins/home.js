...
var $author$project$Main$GotTextString = function (a) {
	return {$: 'GotTextString', a: a};
};
...
var $author$project$Main$myElement = function (str) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 40, 0, 245)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class(
						$author$project$Main$counterClasses(model))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(model.cnt))
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
				...
				A2($mdgriffith$elm_ui$Element$layout, _List_Nil, $author$project$Main$myRowOfStuff),
				A2($elm$html$Html$hr, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$div,
				_List_Nil,
